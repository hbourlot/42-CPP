...
static std::list< Pair > makePairs( std::list< int > &containerList, bool &hasLeftOver, int &leftover ) {
...
static std::list< int > recursiveSortA( std::list< Pair > &pairs ) {
	std::list< int > listA;
...
static std::list< int > insertBs( std::list<int> mainChain, const std::list< Pair > &pairs ) {
